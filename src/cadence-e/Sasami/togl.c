/* $Id: togl.c,v 1.71 2005/04/23 07:49:14 gregcouch Exp $ */
...
/* On Windows, if TOGL_USE_FONTS is 1 (which it is by default, defined
   in togl.h), we need the tkWinInt.h header file.
   As we aren't using fonts in Sasami (yet?), then simpler just to change
   TOGL_USE_FONTS below.  [Ash] */
#define TOGL_USE_FONTS 0
/* ADDED BY ASH - END */
